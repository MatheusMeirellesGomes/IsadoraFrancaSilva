...
Página /botox: explicação educativa do Dysport e dúvidas frequentes. /sobre: apresentação, formação, experiência assistida e cursos. /atendimento-domiciliar: como funciona o atendimento na casa da cliente, privacidade do endereço; região atendida e taxa de deslocamento são combinadas diretamente pelo WhatsApp. /agendamento: formulário com nome, WhatsApp, data, horário e observações (e-mail opcional para lembretes futuros); ao enviar, abre o WhatsApp com os dados preenchidos para Isadora confirmar — o formulário não confirma nada sozinho, você não tem acesso a essa confirmação.
